  ...
  <div id="leo-container-inner">
    <div id="leo-copyright">
     <div id="leo-copyright-inner">
	  ...
	  <a href="http://#" title="Thu vien - Van phong"><?php echo $config->sitename; ?></a>. All rights reserved.
     Design by <a href="http://titanbt.wordpress.com">Huy Nguyen</a></span>
	  <span style="float:right;" class="logo-footer"> Design by <a href="http://titanbt.wordpress.com">Huy Nguyen</a></span>
    </div>
</div>
</div>
</div>
